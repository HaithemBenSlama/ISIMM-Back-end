...
public class DemoApplication {
	...
	public static void main(String[] args) {
		...
		Etudiant e2= new Etudiant("14009108","Ben Abdallah","Syrine",new Date(), Sexe.FEMME,"Monastir","123456789","sirinebenabdallah092@gmail.com","24569321",22,td1,tp1);
		Etudiant e3= new Etudiant("11985827","Ben Slama","Haithem",new Date(), Sexe.HOMME,"Monastir","123456789","Haithem.benslama@hotmail.fr","27660834",22,td1,tp1);
		Etudiant e4= new Etudiant("14020786","Bouzgarrou","Fatma",new Date(), Sexe.FEMME,"Monastir","123456789","fatmabouzgarrou6@gmail.com","29856352",22,td1,tp1);
		Etudiant e5= new Etudiant("14007249","Chaftar","Ghazi",new Date(), Sexe.HOMME,"Monastir","123456789","ghazichaftar@gmail.com","21452365",22,td1,tp1);
		Etudiant e6= new Etudiant("12880792","Chiba","Tasnim",new Date(), Sexe.FEMME,"Monastir","123456789","tasnimchiba@gmail.com","23456859",22,td1,tp1);
		Etudiant e7= new Etudiant("14020269","Elayeb","Oussema",new Date(), Sexe.HOMME,"Monastir","123456789","elayeb.oussama2020@gmail.com","98532012",22,td1,tp1);
		Etudiant e8= new Etudiant("12861799","Ferjani","Nader",new Date(), Sexe.HOMME,"Monastir","123456789","ferjani.nader@hotmail.fr","99632015",22,td1,tp1);
		Etudiant e9= new Etudiant("14657285","Gharouel","Fatma",new Date(), Sexe.FEMME,"Monastir","123456789","gharouelfatma@gmail.com","98152360",22,td1,tp1);
		Etudiant e10= new Etudiant("11984839","Guesmi","Molka",new Date(), Sexe.FEMME,"Monastir","123456789","molka.guesmi20@gmail.com","96321458",22,td1,tp1);
		Etudiant e11= new Etudiant("13281794","Guiza","Asma",new Date(), Sexe.FEMME,"Monastir","123456789","Asma.guiza@ieee.org","96472013",22,td1,tp1);
		Etudiant e12= new Etudiant("12876936","Hajri","Kais",new Date(), Sexe.HOMME,"Monastir","123456789","kais.hajri01@gmail.com","96321582",22,td1,tp1);
		Etudiant e13= new Etudiant("12849683","Hamila","Ahmed",new Date(), Sexe.HOMME,"Monastir","123456789","csahmed17@gmail.com","24563180",22,td1,tp1);
		Etudiant e14= new Etudiant("14030800","Ibrahim","Achraf",new Date(), Sexe.HOMME,"Monastir","123456789","achrefibrahim215@gmail.com","26482395",22,td1,tp2);
		...
		Etudiant e22= new Etudiant("12873880","Rouis","Nour",new Date(), Sexe.FEMME,"Monastir","123456789","nourrouis0@gmail.com","24963856",22,td1,tp2);
		Etudiant e23= new Etudiant("14024333","Saidane","Yassine",new Date(), Sexe.HOMME,"Monastir","123456789","yassinesaidoune003@gmail.com","27415630",22,td1,tp2);
		Etudiant e24= new Etudiant("14322733","Sghaier","Mazen",new Date(), Sexe.HOMME,"Monastir","123456789","Sghaiermazen7@gmail.com","97863425",22,td1,tp2);
		Etudiant e25= new Etudiant("09643569","Tayari","Belhassen",new Date(), Sexe.HOMME,"Monastir","123456789","belhassentayari09@gmail.com","20324571",22,td1,tp2);
		Etudiant e26= new Etudiant("11152975","Trabelsi","Ibrahim",new Date(), Sexe.HOMME,"Monastir","123456789","ib03092001@gmail.com","29864523",22,td1,tp2);
		Etudiant e27= new Etudiant("14011853","Zahaf","Ahmed",new Date(), Sexe.HOMME,"Monastir","123456789","zahafahmed135@gmail.com","55693285",22,td1,tp2);
